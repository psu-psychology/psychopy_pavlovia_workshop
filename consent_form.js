...
function consent_instrRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of consent_instrComponents)
...
function consent_repeatLoopBegin(consent_repeatLoopScheduler) {
  ...
  for (const thisConsent_repeat of consent_repeat) {
...
function repeatRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of repeatComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function agree_disagreeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of agree_disagreeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
