...
function instr_HCRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_HCComponents)
...
function instr_HC_2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_HC_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function instr_HC_3RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_HC_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function HC_repeatLoopBegin(HC_repeatLoopScheduler) {
  ...
  for (const thisHC_repeat of HC_repeat) {
...
function HC_trialsLoopBegin(HC_trialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisHC_trial of HC_trials) {
...
function play_HCRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of play_HCComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function rate_HCRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of rate_HCComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function pass_HCRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pass_HCComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function fail_HC_r1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of fail_HC_r1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function fail_HC_r2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of fail_HC_r2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
